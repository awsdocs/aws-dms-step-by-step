# Migrating a MySQL\-Compatible Database to Amazon Aurora MySQL<a name="CHAP_MySQL2Aurora"></a>
...
#### Creating the IAM Service Role<a name="CHAP_MySQL2Aurora.CreateS3Role"></a>
